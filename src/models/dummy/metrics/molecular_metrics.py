...
from src.models.midi.utils import NoSyncMetric as Metric, NoSyncMetricCollection as MetricCollection
from src.models.midi.analysis.rdkit_functions import check_stability
from src.models.midi.utils import NoSyncMAE as MeanAbsoluteError
from src.models.midi.metrics.metrics_utils import counter_to_tensor, wasserstein1d, total_variation1d
...
if __name__ == '__main__':
    ...
    from src.models.midi.datasets import qm9_dataset, geom_dataset
    from src.models.midi.utils import setup_wandb
